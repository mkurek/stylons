...
var Parser = function() {
	...
	function fmakeList(response) {
		 ...
		 * 
		 * precontent = { data: [ {firstName: 'Tommy', lastName: 'Maintz'},
		 * {firstName: 'Rob', lastName: 'Dougan'}, {firstName: 'Ed', lastName:
		 * 'Spencer'}, {firstName: 'Jamie', lastName: 'Avins'}, {firstName:
		 * 'Aaron', lastName: 'Conran'}, {firstName: 'Dave', lastName:
		 * 'Kaneda'}, {firstName: 'Michael', lastName: 'Mullany'}, {firstName:
		 * 'Abraham', lastName: 'Elias'}, {firstName: 'Jay', lastName:
		 * 'Robinson'} ] };
		 * 
		 * precontent.model = new Ext.regModel('',{ fields:
		 * ['firstName', 'lastName'] });
		 * 
		 * var content = { itemTpl : '{firstName} {lastName}', };
		 * 
		 * content.store = new Ext.data.JsonStore(precontent);
		 * 
		 * var lista = new Ext.List(content);
		 */
